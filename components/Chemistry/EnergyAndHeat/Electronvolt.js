...
const Electronvolt = () => {
    ...
    const [energy, setEnergy] = useState(null); // in Electronvolts (eV)
    ...
    const calculateEnergy = () => {
        ...
        // Convert Joules to Electronvolts (1 eV = 1.60218e-19 J)
        const energyInElectronvolts = energyInJoules / 1.60218e-19;

        setEnergy(energyInElectronvolts.toFixed(2)); // Result in Electronvolts
    };
    ...
    return (
        <ScrollView contentContainerStyle={tw`flex-1 bg-gray-600 p-6`}>
            ...
            <Text style={tw`text-center text-2xl font-bold text-white mb-6`}>
                Electronvolt (eV) Energy Calculator
            </Text>
