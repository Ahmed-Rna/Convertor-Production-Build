...
const MillimeterOfMercury = () => {
    ...
    const calculatePressure = () => {
        ...
        // 1 mmHg = 133.322 Pa
        const pressureInMmHg = pressureInPa / 133.322;

        setPressure(pressureInMmHg.toFixed(5)); // Result in mmHg
    };
    ...
    return (
        <ScrollView contentContainerStyle={tw`flex-1 bg-gray-600 p-6`}>
            ...
            <Text style={tw`text-center text-2xl font-bold text-white mb-6`}>
                Millimeter of Mercury (mmHg) Calculator
            </Text>
...
export default MillimeterOfMercury;
