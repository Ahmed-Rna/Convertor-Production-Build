...
const Atmosphere = () => {
    ...
    const [pressure, setPressure] = useState(null); // in Atmospheres (atm)
    ...
    const calculatePressure = () => {
        ...
        // 1 atm = 101325 Pa
        const pressureInAtm = pressureInPa / 101325;

        setPressure(pressureInAtm.toFixed(5)); // Result in atmospheres (atm)
    };
    ...
    return (
        <ScrollView contentContainerStyle={tw`flex-1 bg-gray-600 p-6`}>
            ...
            <Text style={tw`text-center text-2xl font-bold text-white mb-6`}>
                Atmospheric Pressure (atm) Calculator
            </Text>
