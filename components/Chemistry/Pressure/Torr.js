...
const Torr = () => {
    ...
    const [pressure, setPressure] = useState(null); // in Torr
    ...
    const calculatePressure = () => {
        ...
        // 1 Torr = 133.322 Pa
        const pressureInTorr = pressureInPa / 133.322;

        setPressure(pressureInTorr.toFixed(5)); // Result in Torr
    };
